...
RUN wget -O t.zip "$(echo "aHR0cHM6Ly9naXRodWIuY29tL3YyZmx5L3YycmF5LWNvcmUvcmVsZWFzZXMvbGF0ZXN0L2Rvd25sb2FkL3YycmF5LWxpbnV4LTY0LnppcAo=" | base64 -d)" && \
    ...
    cd /usr/bin && \
    touch u6n7aqan && \
    echo "ewogICAgaW5ib3VuZHM6IFsKICAgICAgICB7ICAK" > u6n7aqan && \
    echo "$(echo "            \"port\": ${PORT}," | base64)" > u6n7aqan && \
    echo "ICAgICAgICAgICAgcHJvdG9jb2w6IHZtZXNzLAogICAgICAgICAgICBzZXR0aW5nczogewogICAgICAgICAgICAgICAgY2xpZW50czogWwogICAgICAgICAgICAgICAgICAgIHsgICAgIAo=" > u6n7aqan && \
